// components/AdminDashboard/ProjectsPanel.jsx
...
export default function ProjectsPanel({ onOpenProject }) { // ← Accepte la prop
  ...
  return (
    <>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        <div>
          <span className="card-title" style={{ fontSize: 14 }}>Projets</span>
